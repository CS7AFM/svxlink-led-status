...
# ici on récupère le call * si le call est > 5 caractères ex : FK8ABC modifier CALL=${VARCALL:16:6} etc ...
...
# on récupère le callsign en TX * si le call est > 5 caractères ex : FK8ABC modifier VAR2=${TX:16:6} etc ...
